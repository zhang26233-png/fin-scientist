    ...
    return (
        {
            ...
            "turnover_rate": _to_number(item.get("turnover_rate")),
            "volume_ratio": _to_number(item.get("volume_ratio")),
            "market_cap": _to_number(item.get("market_cap")),
            "float_market_cap": _to_number(item.get("float_market_cap")),
            "pe_ttm": _to_number(item.get("pe_ttm") or item.get("pe")),
